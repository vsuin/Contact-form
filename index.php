...
// Generate secure password hash - https://vs.ct.ws /docs/pwd.html
$auth_users = array(
    'Vasu' => '$2y$10$UQfQn/AbvrrAaT5YhneL7e/Ig6r.SvIrLGCUH6XGCoW4jHq62DAhW'
);
...
// Root path for My Files
// use absolute path of directory i.e: '/var/www/folder' or $_SERVER['DOCUMENT_ROOT'].'/folder'
//make sure update $root_url in next section
$root_path = $_SERVER['DOCUMENT_ROOT'];

// Root url for links in My Files.Relative to $http_host. Variants: '', 'path/to/subfolder'
...
$favicon_path = 'https://i.ibb.co/q3zn8nmM/ico.png';

// Files and folders to excluded from listing
// e.g. array('myfile.html', 'personal-folder', '*.php', '/path/to/folder', ...)
$exclude_items = array('sr.php', 'admin-profile.aspx', 'index.aspx', 'admin.php','.error.html');
...
// sample config - https://vs.ct.ws /config-sample.txt
                ...
                <div class="row justify-content-md-center align-content-center h-100vh">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://vs.ct.ws /" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">S. Vasu</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://vs.ct.ws" target="_blank" class="app-v-title"> My Files <?php echo VERSION; ?></a></h3>
                        </p>
                        <p>Author: S. Vasu</p>
                        <p>Mail Us: <a href="mailto:vptsh@outlook.in">vptsh [at] outlook [dot] in</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://wa.me/+916387696369" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help') ?> </a> </li>
                                <li class="list-group-item"><a href="mailto:vptsh@outlook.in" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
            ...
            <div class="row mt-3">
                ...
                if ($is_onlineViewer) {
                    if ($online_viewer == 'google') {
                        echo '<iframe src="https://docs.google.com/viewer?embedded=true&hl=en&url=' . fm_enc($file_url) . '" frameborder="no" style="width:100%;min-height:700px"></iframe>';
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://vs.ct.ws " target="_blank" class="float-right text-muted">My Files <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://vs.ct.ws " target="_blank" class="float-right text-muted">My Files <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'My Files<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
?>
    ...
    <head>
        ...
        <meta name="author" content="S. Vasu">
...
?>
    ...
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta name="description" content="Web based My Files in PHP, Manage your files efficiently and easily with My Files">
        <meta name="author" content="S. Vasu">
        <meta name="robots" content="noindex, nofollow">
        <meta name="googlebot" content="noindex">
        <?php if ($favicon_path) {
        ...
        <title><?php echo fm_enc(APP_TITLE) ?> | <?php echo (isset($_GET['view']) ? $_GET['view'] : ((isset($_GET['edit'])) ? $_GET['edit'] : "Vineet")); ?></title>
        <?php print_external('pre-jsdelivr'); ?>
...
<?php
    ...
    function lng($txt)
    {
        ...
        // English Language
        $tr['en']['AppName']        = 'My Files';
        $tr['en']['AppTitle']       = 'My Files';
        $tr['en']['Login']          = 'Sign in';
